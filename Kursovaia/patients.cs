...
namespace Kursovaia
{
    public partial class patients : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string sql_delete_user = "DELETE FROM patients WHERE id_pat='" + id_selected_rows + "'";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            edit_pat edit_user = new edit_pat();
        ...
        {
            {
                ...
                {
                    bSource.Filter = "id_pat='" + toolStripTextBox1.Text + "'";
                }
                else
                {
