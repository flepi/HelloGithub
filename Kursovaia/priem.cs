...
namespace Kursovaia
{
    public partial class priem : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string new_time = textBox4.Text;
            string new_cab = textBox5.Text;
            ...
            try
            {
                ...
                MessageBox.Show("Запись прошла успешна ", "Информация", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
